...
* Sistema operacional Windows (o programa utiliza a API Windows para interagir com a área de transferência).

## Compilação e Execução
1. Compile o programa utilizando um compilador C++. Exemplo com g++:
```
g++ -o stronghold-finder stronghold-finder.cpp
```
...
* Este é meu primeiro projeto em C++, então, por favor, tenha piedade se encontrar algum código mal escrito. Estou aberto a sugestões e críticas construtivas.
